...
- The **teardown-script** follows the same principle. Please note that teardown_script files should be placed in the student/scripts directory to allow isolation from the student (unless he has root access).
