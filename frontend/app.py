...
urls = (
    ...
    '/admin/([^/]+)/group/([^/]+)', 'frontend.pages.course_admin.group_info.CourseGroupInfoPage',
    '/admin/([^/]+)/group/([^/]+)/([^/]+)', 'frontend.pages.course_admin.group_task.CourseGroupTaskPage',
    '/admin/([^/]+)/group/([^/]+)/([^/]+)/([^/]+)', 'frontend.pages.course_admin.group_task.SubmissionDownloadFeedback',
