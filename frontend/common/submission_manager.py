...
class SubmissionManager(object):
    ...
    def __init__(self, job_manager, user_manager, database, gridfs, hook_manager):
        """
        :type job_manager: backend.job_managers.abstract.AbstractJobManager
        :type user_manager: frontend.common.user_manager.AbstractUserManager
        :type database: pymongo.database.Database
        :type gridfs: gridfs.GridFS
        :type hook_manager: common.hook_manager.HookManager
        :return:
        """
    ...
    def add_job(self, task, inputdata, debug=False):
        ...
        :type task: frontend.common.tasks.FrontendTask
