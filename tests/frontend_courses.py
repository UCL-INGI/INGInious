...
class frontend_courses(unittest.TestCase):
    ...
    def test_completion_percentage(self):
        ...
        print "\033[1m-> inginious.frontend-course: completion percentage\033[0m"
    ...
    def test_last_submissions(self):
        ...
        print "\033[1m-> inginious.frontend-course: lasts submissions\033[0m"
        c = inginious.frontend.custom.courses.FrontendCourse('test2')
        t = inginious.common.tasks.Task(c, 'task1')
...
if __name__ == "__main__":
    if not inginious.common.base.INGIniousConfiguration.get('tests', {}).get('host_url', ''):
        ...
        print "\033[31;1m-> inginious.frontend-courses: tests cannot be run remotely\033[0m"
