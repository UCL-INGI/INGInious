...
def ssh_student(cmd=None, memory_limit=0, hard_time_limit=0, time_limit=0, container=None, run_as_root=False):
    """
    ...
    :param cmd: command to be ran (as a string, with parameters) before launching the ssh server. This command, in the case of a script, is allowed to start new subprocess.
    ...
    """
    return inginious_container_api.run_student.run_student(cmd=cmd, container=container, time_limit=time_limit,
