...
class LTILaunchPage(INGIniousPage):
    ...
    def POST(self, courseid, taskid):
        ...
        if loggedin:
            return redirect(self.app.get_homepath(force_cookieless=True, new_sessionid=sessionid) + "/lti/task")
        else:
            return redirect(self.app.get_homepath(force_cookieless=True, new_sessionid=sessionid) + "/lti/login")
