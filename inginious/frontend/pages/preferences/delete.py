...
class DeletePage(INGIniousAuthPage):
    ...
    def GET_AUTH(self):  # pylint: disable=arguments-differ
        ...
        if not userdata or not self.app.allow_deletion:
            raise self.app.internalerror(message=_("User unavailable or deletion is forbidden."))
    ...
    def POST_AUTH(self):  # pylint: disable=arguments-differ
        ...
        if not userdata or not self.app.allow_deletion:
            raise self.app.internalerror(message=_("User unavailable or deletion forbidden."))
