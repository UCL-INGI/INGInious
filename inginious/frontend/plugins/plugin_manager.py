...
class PluginManager(HookManager):
    ...
    def load(self):
        """ Loads the plugin manager. Must be done after the initialisation of the inginious.backend """
    ...
    def register_auth_method(self, name, input_to_display, callback):
        """
            ...
            name
                the name of the authentication method, typically displayed by the inginious.frontend
