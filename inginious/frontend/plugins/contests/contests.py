...
def course_menu(course):
    ...
    if contest_data['enabled']:
        ...
        return str(get_template_renderer('inginious.frontend/plugins/contests').course_menu(course, start, end, blackout))
    else:
        return None
...
class ContestScoreboard(object):
    ...
    def GET(self, courseid):
        ...
        return get_template_renderer('inginious.frontend/plugins/contests', '../../../templates/layout').scoreboard(course, start, end, blackout, tasks, results, activity)
    # except:
    #        raise web.notfound()
...
class ContestAdmin(object):
    ...
    def GET(self, courseid):
        ...
        contest_data = get_contest_data(course)
        return get_template_renderer('inginious.frontend/plugins/contests', '../../../templates/layout').admin(course, contest_data, None, False)
    ...
    def POST(self, courseid):
        ...
        if len(errors) == 0:
            ...
            return get_template_renderer('inginious.frontend/plugins/contests', '../../../templates/layout').admin(course, contest_data, None, True)
        else:
            return get_template_renderer('inginious.frontend/plugins/contests', '../../../templates/layout').admin(course, contest_data, errors, False)
