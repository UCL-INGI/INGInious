...
def init(plugin_manager, course_factory, client, config):
    ...
    plugin_manager.add_page(r'/plugins/problems_bank/api/copy_task', CopyTaskApi)
    plugin_manager.add_page(r'/plugins/problems_bank/api/bank_courses', ManageBanksCoursesApi)
    plugin_manager.add_page(r'/plugins/problems_bank/api/available_courses', AvailableCoursesApi)
    plugin_manager.add_page(r'/plugins/problems_bank/api/bank_tasks',SearchTaskApi)
    plugin_manager.add_page(r'/plugins/problems_bank/api/filter_bank_tasks', FilterTasksApi)
