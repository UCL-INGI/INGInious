...
class UpComingTasksBoard(INGIniousAuthPage):
    ...
    def page(self, time_planner):
        ...
        #all_courses = self.taskset_factory.get_all_courses()  # AttributeError("'TasksetFactory' object has no attribute 'get_all_courses'")
        all_courses = self.taskset_factory.get_all_tasksets()  # AttributeError("'TasksetFactory' object has no attribute 'get_all_courses'")
