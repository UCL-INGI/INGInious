...
def create_arch(configuration, filesystem, problem_types, context):
    ...
    :param filesystem: The filesystem to be used by the frontend
    ...
    if backend_link == "local":
        ...
        agent_docker = DockerAgent(context, "inproc://backend_agent", "Docker - Local agent", concurrency, filesystem, debug_host, debug_ports, tmp_dir)
        agent_mcq = MCQAgent(context, "inproc://backend_agent", "MCQ - Local agent", 1, filesystem, problem_types)
