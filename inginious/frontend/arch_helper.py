...
def create_arch(configuration, tasks_fs, context, course_factory):
    ...
    if backend_link == "local":
        ...
        agent_docker = DockerAgent(context, "inproc://backend_agent", "Docker - Local agent", concurrency, tasks_fs, debug_host, debug_ports, tmp_dir, ssh_allowed=True, kvm_allowed=True)
