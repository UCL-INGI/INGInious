...
urls = (
    ...
    r'/team/([^/]+)', 'inginious.frontend.pages.team.AggregationPage',
    r'/classroom/([^/]+)', 'inginious.frontend.pages.classroom.AggregationPage',
    ...
    r'/admin/([^/]+)/classrooms', 'inginious.frontend.pages.course_admin.classroom_list.CourseAggregationListPage',
    r'/admin/([^/]+)/classroom/([^/]+)', 'inginious.frontend.pages.course_admin.classroom_info.CourseAggregationInfoPage',
    r'/admin/([^/]+)/teams', 'inginious.frontend.pages.course_admin.team_list.CourseAggregationListPage',
    r'/admin/([^/]+)/team/([^/]+)', 'inginious.frontend.pages.course_admin.team_info.CourseAggregationInfoPage',
    ...
    r'/admin/([^/]+)/edit/team/([^/]+)', 'inginious.frontend.pages.course_admin.team_edit.CourseEditAggregation',
    r'/admin/([^/]+)/edit/teams', 'inginious.frontend.pages.course_admin.team_edit.CourseEditAggregation',
    r'/admin/([^/]+)/edit/classroom/([^/]+)', 'inginious.frontend.pages.course_admin.classroom_edit.CourseEditAggregation',
    r'/admin/([^/]+)/edit/classrooms', 'inginious.frontend.pages.course_admin.classroom_edit.CourseEditAggregation',
