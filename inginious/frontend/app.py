...
urls = (
    ...
    r'/admin/([^/]+)/classrooms', 'inginious.frontend.pages.course_admin.classroom_list.CourseClassroomListPage',
    r'/admin/([^/]+)/classroom/([^/]+)', 'inginious.frontend.pages.course_admin.classroom_info.CourseClassroomInfoPage',
    r'/admin/([^/]+)/teams', 'inginious.frontend.pages.course_admin.team_list.CourseTeamListPage',
    r'/admin/([^/]+)/team/([^/]+)', 'inginious.frontend.pages.course_admin.team_info.CourseTeamInfoPage',
    ...
    r'/admin/([^/]+)/edit/classrooms', 'inginious.frontend.pages.course_admin.classroom_edit.CourseEditClassroom',
