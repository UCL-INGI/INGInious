...
""" Some helpers to manage cgroups. This file is not used on systems other than Linux.
    _cgroup_abstraction.py provides an asyncio-compatible versions of these utilities, along with a fallback for other OSes
"""
...
class CGroupTimeoutWatcher(object):
